...
export class QPayError extends Error {
  constructor(message, { status, code, payload } = {}) {
    ...
    this.status = status
    this.code = code
    // The whole response body, kept because QPay's useful detail is often a
    // nested object rather than a message string.
    this.payload = payload
  }
}

/** QPay answers some failures with an object, which interpolates to [object Object]. */
